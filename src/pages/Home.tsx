            ...
            <CardContent>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="text-sm text-muted-foreground mt-1">Jan 01</span>
                  <p className="font-medium">New semester begins for all departments.</p>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-sm text-muted-foreground mt-1">Jan 05</span>
                  <p className="font-medium">Annual sports meet announced for February.</p>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-sm text-muted-foreground mt-1">Jan 10</span>
                  <p className="font-medium">Workshop on AI/ML to be held next week.</p>
                </li>
              </ul>
            </CardContent>
          </Card>
